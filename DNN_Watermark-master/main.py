...
KEY_DIM = (28, 32, 32, 224, 32)  # equal to image dimension: MNIST 28， CIFAR10 32， CIFAR100 32， FOOD101 224
...
if __name__ == '__main__':
    ...
    dataset_name = {0: 'MNIST', 1: 'CIFAR10', 2: 'CIFAR100', 3: 'FOOD101',4: 'SVHN'}  # corresponding model: [ResNet18_p2, ResNet18_p64, wrn_28_10, efficientnet]
    ...
    #test_path = './trained/MNIST/FixLL+PFL/MNIST_ResNet18_FixLL+PFL_Epoch_5_test_acc_99.36%_trigger_acc_13.10%_n_100_m_10_mix_(64)10_LP_0.0000.pt'
    ref_path = './ref_models/deep_fidelity/MNIST_ref.pt'
